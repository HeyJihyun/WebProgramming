...
<section id="accountList" class="container text-center">
    <div class="row" style="max-width: 700px;">
        ...
        <div id="carouse1" class="carousel carousel-dark slide p-3" data-bs-ride="carousel">
            <div class="carousel-indicators">
                <c:forEach var="i" begin="1" end="${fn:length(accountList)}">
                    <button type="button" data-bs-target="#carouse1" data-bs-slide-to="${i-1}" class="<c:if test='${i == 1}'> active" aria-current="true</c:if>" aria-label="Slide ${i}"></button>
                </c:forEach>
            </div>
                        ...
                        <div class="card col-12 mb-3 border-warning ">
                            ...
                            <div class="card-body">
                                <form method="post">
                                    ...
                                    <input type="hidden" name="account_id" value="${account.account_id }"> <input type="hidden" name="account_no" value="${account.account_no }"> <input type="hidden" name="bank_cd" value="${account.bank_cd }">
                                    <div class="row">
